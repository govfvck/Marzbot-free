...
T = TypeVar("T", bound="UserTemplateModify")
...
class UserTemplateModify:
    ...
    inbounds: Union[Unset, "UserTemplateModifyInbounds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_inbounds, Unset):
            ...
            inbounds = UserTemplateModifyInbounds.from_dict(_inbounds)

        user_template_modify = cls(
            name=name,
        ...
        user_template_modify.additional_properties = d
        return user_template_modify
