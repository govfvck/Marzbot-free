...
T = TypeVar("T", bound="UserCreateProxies")


@_attrs_define
class UserCreateProxies:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_create_proxies.additional_properties = additional_properties
        return user_create_proxies
